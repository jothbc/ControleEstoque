 ...
 * @author User
 */
public class Baixas_Lancar_Frm extends javax.swing.JFrame {
    ...
    /**
     * Creates new form Baixas_Lancar_Frm
     */
    public Baixas_Lancar_Frm(String user_) {
        initComponents();
        this.setExtendedState(Baixas_Lancar_Frm.MAXIMIZED_BOTH);
    ...
    private void initComponents() {
        ...
        setTitle("Baixas - Supermercado Correia");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Baixas_Lancar_Frm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Baixas_Lancar_Frm(null).setVisible(true);
            }
        });
    }
